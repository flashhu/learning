...
function doShowMore(e) {
  $('body').append('<div class="g-show"><div class="m-wrap"><div class="m-data m-data-w"></div><div class="m-body-w"><h3 class="m-title-w"></h3><p class="m-html m-html-w"></p></div><div class="m-close"></div> </div></div>')
